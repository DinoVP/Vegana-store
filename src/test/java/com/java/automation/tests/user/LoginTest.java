...
/**
 * Test cases for Login functionality (Client/User)
 */
public class LoginTest extends BaseTest {

    @Test(priority = 1, description = "Test đăng nhập thành công với thông tin hợp lệ (TC1)")
    public void testLoginSuccess() {
        ...
        // FIX: Đảm bảo sử dụng hàm isCustomerAccountDisplayed() đã được sửa
        Assert.assertTrue(loginPage.isCustomerAccountDisplayed(),
                "Đăng nhập thành công nhưng không redirect về trang My Account/Account");
    }
